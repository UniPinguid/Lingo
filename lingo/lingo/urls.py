...
urlpatterns = [
    ...
    path('project/tasks/class/<int:datasetid>', dataset_classification, name='dataset_classification'),
    path('project/tasks/class/edit/<int:datasetid>', dataset_classification_edit, name='classification_edit'),
